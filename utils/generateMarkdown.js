...
function generateMarkdown(response, questions) {
  ...
  ## Questions
  If you have any questions about the repository, open an issue or contact me directly at ${response.questions}. You can find more of my work at ${response.username}.
`;
}
